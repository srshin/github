...
public class WeatherService {
	...
	public String[][] resultString(String oneName, String condition) {
		...
		for (WeatherVO vo : resultlist) {
			...
			if (vo.getYear().equals("2013")) row=1;
			else if (vo.getYear().equals("2014")) row=2;
			else if (vo.getYear().equals("2015")) row=3;
			else if (vo.getYear().equals("2016")) row=4;
			else if (vo.getYear().equals("2017")) row=5;
