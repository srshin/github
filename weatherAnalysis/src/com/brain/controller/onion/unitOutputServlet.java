...
@WebServlet("/onion/unitOutput.do")
public class unitOutputServlet extends HttpServlet {
...
//연별 전국 양파 총생산량 변화추	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("unitOutputList", service.unitOutput());
		
		RequestDispatcher rd = request.getRequestDispatcher("/onion/unitOutput.jsp");
